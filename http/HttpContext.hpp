...
public:
  ...
  {
    startResponse(code, HttpDefination::getMessage(code));
  }
  ...
  void sendContent(const std::string& contents)
  {
  ...
  {
    sendError(code, HttpDefination::getMessage(code));
  }
